"""Experimental extraction of grind position-adjustment handlers.

These functions are source-equivalent to the original NFI methods by AST
comparison, but wiring them through NFIRefactorStrategy caused a small
backtest parity drift on 2025-10-16..2026-04-15. Keep this module unused
until the callback-dispatch side effect is fully understood.
"""
...
def long_grind_adjust_trade_position_v2(
  ...
  **kwargs,
  ...
  is_long_buyback_entry = strategy.long_buyback_entry_v2(last_candle, previous_candle, slice_profit, True)
  is_long_grind_entry = (
    strategy.long_grind_entry_v2(last_candle, previous_candle, slice_profit, True)
    or (
  ...
  if grind_1_sub_grind_count > 0:
    ...
    if (grind_profit > (grind_1_profit_threshold + fee_open_rate + fee_close_rate)) and strategy.long_grind_exit_v2(
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Grinding de-risk (grind_1_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {grind_1_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({grind_1_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if grind_2_sub_grind_count > 0:
    ...
    if (grind_profit > (grind_2_profit_threshold + fee_open_rate + fee_close_rate)) and strategy.long_grind_exit_v2(
      last_candle, previous_candle, slice_profit, True
    ):
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Grinding de-risk (grind_2_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {grind_2_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({grind_2_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if grind_3_sub_grind_count > 0:
    ...
    if (grind_profit > (grind_3_profit_threshold + fee_open_rate + fee_close_rate)) and strategy.long_grind_exit_v2(
      last_candle, previous_candle, slice_profit, True
    ):
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Grinding de-risk (grind_3_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {grind_3_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({grind_3_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if grind_4_sub_grind_count > 0:
    ...
    if (grind_profit > (grind_4_profit_threshold + fee_open_rate + fee_close_rate)) and strategy.long_grind_exit_v2(
      last_candle, previous_candle, slice_profit, True
    ):
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Grinding de-risk (grind_4_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {grind_4_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({grind_4_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if grind_5_sub_grind_count > 0:
    ...
    if (grind_profit > (grind_5_profit_threshold + fee_open_rate + fee_close_rate)) and strategy.long_grind_exit_v2(
      last_candle, previous_candle, slice_profit, True
    ):
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Grinding de-risk (grind_5_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {grind_5_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({grind_5_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if buyback_1_sub_grind_count > 0:
    ...
    ) and strategy.long_grind_exit_v2(last_candle, previous_candle, slice_profit, True):
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Buyback de-risk (buyback_1_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {buyback_1_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({buyback_1_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Buyback de-risk (buyback_2_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {buyback_2_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({buyback_2_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
  ...
  if (
    ...
    if sell_amount > min_stake and ft_sell_amount > min_stake:
      ...
      log.info(
        f"Buyback de-risk (buyback_3_derisk) [{current_time}] [{trade.pair}] | Rate: {exit_rate} | Stake amount: {sell_amount} | Coin amount: {buyback_3_total_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}% | Grind profit: {(grind_profit * 100.0):.2f}% ({buyback_3_current_grind_stake_profit} {strategy.config['stake_currency']})"
      )
...
def long_grind_adjust_trade_position_v3(
  strategy,
  trade: Trade,
  enter_tags,
  current_time: datetime,
  ...
  **kwargs,
  ...
  grind_1_max_sub_grinds = 0
  grind_1_stakes = (
    strategy.system_v3_grind_1_stakes_futures.copy()
    if strategy.is_futures_mode
    else strategy.system_v3_grind_1_stakes_spot.copy()
  )
  grind_1_sub_thresholds = (
    strategy.system_v3_grind_1_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_grind_1_thresholds_spot
  )
  if (slice_amount * grind_1_stakes[0] / trade.leverage) < min_stake:
    multi = min_stake / slice_amount / grind_1_stakes[0] * trade.leverage
    for i, _ in enumerate(grind_1_stakes):
      grind_1_stakes[i] *= multi
  grind_1_max_sub_grinds = len(grind_1_stakes)
  grind_1_derisk_grinds = (
    strategy.system_v3_grind_1_derisk_futures if strategy.is_futures_mode else strategy.system_v3_grind_1_derisk_spot
  )
  grind_1_profit_threshold = (
    strategy.system_v3_grind_1_profit_threshold_futures
    if strategy.is_futures_mode
    else strategy.system_v3_grind_1_profit_threshold_spot
  )

  grind_2_max_sub_grinds = 0
  grind_2_stakes = (
    strategy.system_v3_grind_2_stakes_futures.copy()
    if strategy.is_futures_mode
    else strategy.system_v3_grind_2_stakes_spot.copy()
  )
  grind_2_sub_thresholds = (
    strategy.system_v3_grind_2_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_grind_2_thresholds_spot
  )
  if (slice_amount * grind_2_stakes[0] / (trade.leverage if strategy.is_futures_mode else 1.0)) < min_stake:
    multi = min_stake / slice_amount / grind_2_stakes[0] * trade.leverage
    for i, _ in enumerate(grind_2_stakes):
  ...
  grind_2_max_sub_grinds = len(grind_2_stakes)
  grind_2_derisk_grinds = (
    strategy.system_v3_grind_2_derisk_futures if strategy.is_futures_mode else strategy.system_v3_grind_2_derisk_spot
  )
  grind_2_profit_threshold = (
    strategy.system_v3_grind_2_profit_threshold_futures
    if strategy.is_futures_mode
    else strategy.system_v3_grind_2_profit_threshold_spot
  )

  grind_3_max_sub_grinds = 0
  grind_3_stakes = (
    strategy.system_v3_grind_3_stakes_futures.copy()
    if strategy.is_futures_mode
    else strategy.system_v3_grind_3_stakes_spot.copy()
  )
  grind_3_sub_thresholds = (
    strategy.system_v3_grind_3_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_grind_3_thresholds_spot
  )
  if (slice_amount * grind_3_stakes[0] / (trade.leverage if strategy.is_futures_mode else 1.0)) < min_stake:
    multi = min_stake / slice_amount / grind_3_stakes[0] * trade.leverage
    for i, _ in enumerate(grind_3_stakes):
  ...
  grind_3_max_sub_grinds = len(grind_3_stakes)
  grind_3_derisk_grinds = (
    strategy.system_v3_grind_3_derisk_futures if strategy.is_futures_mode else strategy.system_v3_grind_3_derisk_spot
  )
  grind_3_profit_threshold = (
    strategy.system_v3_grind_3_profit_threshold_futures
    if strategy.is_futures_mode
    else strategy.system_v3_grind_3_profit_threshold_spot
  )

  grind_4_max_sub_grinds = 0
  grind_4_stakes = (
    strategy.system_v3_grind_4_stakes_futures.copy()
    if strategy.is_futures_mode
    else strategy.system_v3_grind_4_stakes_spot.copy()
  )
  grind_4_sub_thresholds = (
    strategy.system_v3_grind_4_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_grind_4_thresholds_spot
  )
  if (slice_amount * grind_4_stakes[0] / (trade.leverage if strategy.is_futures_mode else 1.0)) < min_stake:
    multi = min_stake / slice_amount / grind_4_stakes[0] * trade.leverage
    for i, _ in enumerate(grind_4_stakes):
  ...
  grind_4_max_sub_grinds = len(grind_4_stakes)
  grind_4_derisk_grinds = (
    strategy.system_v3_grind_4_derisk_futures if strategy.is_futures_mode else strategy.system_v3_grind_4_derisk_spot
  )
  grind_4_profit_threshold = (
    strategy.system_v3_grind_4_profit_threshold_futures
    if strategy.is_futures_mode
    else strategy.system_v3_grind_4_profit_threshold_spot
  )

  grind_5_max_sub_grinds = 0
  grind_5_stakes = (
    strategy.system_v3_grind_5_stakes_futures.copy()
    if strategy.is_futures_mode
    else strategy.system_v3_grind_5_stakes_spot.copy()
  )
  grind_5_sub_thresholds = (
    strategy.system_v3_grind_5_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_grind_5_thresholds_spot
  )
  if (slice_amount * grind_5_stakes[0] / (trade.leverage if strategy.is_futures_mode else 1.0)) < min_stake:
    multi = min_stake / slice_amount / grind_5_stakes[0] * trade.leverage
    for i, _ in enumerate(grind_5_stakes):
  ...
  grind_5_max_sub_grinds = len(grind_5_stakes)
  grind_5_derisk_grinds = (
    strategy.system_v3_grind_5_derisk_futures if strategy.is_futures_mode else strategy.system_v3_grind_5_derisk_spot
  )
  grind_5_profit_threshold = (
    strategy.system_v3_grind_5_profit_threshold_futures
    if strategy.is_futures_mode
    else strategy.system_v3_grind_5_profit_threshold_spot
  )

  rebuy_stakes = (
    strategy.system_v3_1_rebuy_stakes_futures if strategy.is_futures_mode else strategy.system_v3_1_rebuy_stakes_spot
  )
  rebuy_max_sub_grinds = len(rebuy_stakes)
  rebuy_sub_thresholds = (
    strategy.system_v3_1_rebuy_thresholds_futures if strategy.is_futures_mode else strategy.system_v3_1_rebuy_thresholds_spot
  )
  ...
  if is_rebuy_mode:
    slice_amount /= strategy.rebuy_mode_stake_multiplier
  # not reached the max allowed stake for all grinds
  is_not_trade_max_stake_v3 = current_stake_amount < (slice_amount * strategy.system_v3_max_stake)
  is_not_trade_max_stake_v3_1 = current_stake_amount < (slice_amount * strategy.system_v3_1_max_stake)
  ...
  is_long_grind_entry = strategy.long_grind_entry_v3(last_candle, previous_candle, slice_profit, True)
  is_long_buyback_entry = strategy.long_buyback_entry_v3(last_candle, previous_candle, slice_profit, True)
  is_long_rebuy_entry = strategy.long_rebuy_entry_v3(last_candle, previous_candle, slice_profit, True)
  ...
  if (
    strategy.derisk_enable
    and (
      (is_system_v3 and strategy.system_v3_derisk_level_1_enable)
      or (is_system_v3_2 and strategy.system_v3_2_derisk_level_1_enable)
    )
    and (not is_derisk_1_found)
    and not is_rebuy_mode
    and (
      ...
      < (
        ...
        * (
          (
            strategy.system_v3_derisk_level_1_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_1_spot[1]
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_1_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_1_spot[1]
          )
        )
      )
      / trade.leverage
    ...
    sell_amount = (
      (
        ...
        * (
          (
            strategy.system_v3_derisk_level_1_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_1_stake_spot
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_1_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_1_stake_spot
          )
        )
      )
      * exit_rate
  ...
  if (
    strategy.derisk_enable
    and (
      (is_system_v3 and strategy.system_v3_derisk_level_2_enable)
      or (is_system_v3_2 and strategy.system_v3_2_derisk_level_2_enable)
    )
    and not is_derisk_2_found
    and not is_rebuy_mode
    and (
      ...
      < (
        ...
        * (
          (
            strategy.system_v3_derisk_level_2_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_2_spot[1]
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_2_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_2_spot[1]
          )
        )
      )
      / trade.leverage
    ...
    sell_amount = (
      (
        ...
        * (
          (
            strategy.system_v3_derisk_level_2_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_2_stake_spot
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_2_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_2_stake_spot
          )
        )
      )
      * exit_rate
  ...
  if (
    strategy.derisk_enable
    and (
      (is_system_v3 and strategy.system_v3_derisk_level_3_enable)
      or (is_system_v3_2 and strategy.system_v3_2_derisk_level_3_enable)
    )
    and not is_derisk_3_found
    and not is_rebuy_mode
    and (
      ...
      < (
        ...
        * (
          (
            strategy.system_v3_derisk_level_3_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_3_spot[1]
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_3_futures[1]
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_3_spot[1]
          )
        )
      )
      / trade.leverage
    ...
    sell_amount = (
      (
        ...
        * (
          (
            strategy.system_v3_derisk_level_3_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_derisk_level_3_stake_spot
          )
          if is_system_v3
          else (
            strategy.system_v3_2_derisk_level_3_stake_futures
            if strategy.is_futures_mode
            else strategy.system_v3_2_derisk_level_3_stake_spot
          )
        )
      )
      * exit_rate
  ...
  if (
    strategy.derisk_enable
    and (is_system_v3_2 and strategy.system_v3_2_derisk_level_4_enable)
    ...
    and (
      ...
      < (
        slice_amount
        * (
          strategy.system_v3_2_derisk_level_4_futures[1]
          if strategy.is_futures_mode
          else strategy.system_v3_2_derisk_level_4_spot[1]
        )
      )
      / trade.leverage
    )
    ...
    sell_amount = (
      (
        filled_entries[0].safe_filled
        * (
          strategy.system_v3_2_derisk_level_4_stake_futures
          if strategy.is_futures_mode
          else strategy.system_v3_2_derisk_level_4_stake_spot
        )
      )
      * exit_rate
      / trade.leverage
  ...
  if (
    (strategy.system_v3_grind_1_enable)
    # and is_derisk_1_found
    and is_long_grind_entry
    and is_long_extra_checks_entry
    and (grind_1_sub_grind_count < grind_1_max_sub_grinds)
  ...
  if (
    strategy.system_v3_grind_1_use_derisk
    and (grind_1_sub_grind_count > 0)
    and (((exit_rate - grind_1_current_open_rate) / grind_1_current_open_rate) < grind_1_derisk_grinds)
  ):
    # if (
  ...
  if (
    (strategy.system_v3_grind_2_enable)
    # and is_derisk_1_found
    and is_long_grind_entry
    and is_long_extra_checks_entry
    and (grind_2_sub_grind_count < grind_2_max_sub_grinds)
  ...
  if (
    strategy.system_v3_grind_2_use_derisk
    and (grind_2_sub_grind_count > 0)
    and (((exit_rate - grind_2_current_open_rate) / grind_2_current_open_rate) < grind_2_derisk_grinds)
  ):
    # if (
  ...
  if (
    (strategy.system_v3_grind_3_enable)
    # and is_derisk_1_found
    and is_long_grind_entry
    and is_long_extra_checks_entry
    and (grind_3_sub_grind_count < grind_3_max_sub_grinds)
  ...
  if (
    strategy.system_v3_grind_3_use_derisk
    and (grind_3_sub_grind_count > 0)
    and (((exit_rate - grind_3_current_open_rate) / grind_3_current_open_rate) < grind_3_derisk_grinds)
  ):
    # if (
  ...
  if (
    (strategy.system_v3_grind_4_enable)
    # and is_derisk_1_found
    and is_long_grind_entry
    and is_long_extra_checks_entry
    and (grind_4_sub_grind_count < grind_4_max_sub_grinds)
  ...
  if (
    strategy.system_v3_grind_4_use_derisk
    and (grind_4_sub_grind_count > 0)
    and (((exit_rate - grind_4_current_open_rate) / grind_4_current_open_rate) < grind_4_derisk_grinds)
  ):
    # if (
  ...
  if (
    (strategy.system_v3_grind_5_enable)
    # and is_derisk_1_found
    and is_long_grind_entry
    and is_long_extra_checks_entry
    and (grind_5_sub_grind_count < grind_5_max_sub_grinds)
  ...
  if (
    strategy.system_v3_grind_5_use_derisk
    and (grind_5_sub_grind_count > 0)
    and (((exit_rate - grind_5_current_open_rate) / grind_5_current_open_rate) < grind_5_derisk_grinds)
  ):
    # if (
  ...
  if (
    strategy.system_v3_buyback_1_enable
    and is_system_v3_2
    ...
    and (
      (
        buyback_1_exit_distance_ratio
        < (
          strategy.system_v3_buyback_1_distance_ratio_negative_futures
          if strategy.is_futures_mode
          else strategy.system_v3_buyback_1_distance_ratio_negative_spot
        )
      )
      or (
        buyback_1_exit_distance_ratio
        > (
          strategy.system_v3_buyback_1_distance_ratio_positive_futures
          if strategy.is_futures_mode
          else strategy.system_v3_buyback_1_distance_ratio_positive_spot
        )
      )
    )
    and is_not_trade_max_stake_v3
    ...
    buy_amount = (
      slice_amount
      * (strategy.system_v3_buyback_1_stake_futures if strategy.is_futures_mode else strategy.system_v3_buyback_1_stake_spot)
      / trade.leverage
    )
    if buy_amount < (min_stake * 1.5):
      buy_amount = min_stake * 1.5
  ...
  #     > (
  #       (
  #         strategy.system_v3_buyback_1_profit_threshold_futures
  #         if strategy.is_futures_mode
  #         else strategy.system_v3_buyback_1_profit_threshold_spot
  #       )
  #       + fee_open_rate
  #       + fee_close_rate
  #     )
  ...
  # ):
  if (
    strategy.system_v3_buyback_1_use_derisk
    and (buyback_1_sub_grind_count > 0)
    and (
      buyback_1_current_grind_stake_profit
      < (
        slice_amount
        * (strategy.system_v3_buyback_1_derisk_futures if strategy.is_futures_mode else strategy.system_v3_buyback_1_derisk_spot)
      )
    )
  ):
    sell_amount = buyback_1_total_amount * exit_rate / trade.leverage
  ...
  if (
    ...
    buy_amount = slice_amount * rebuy_stakes[rebuy_sub_grind_count] / trade.leverage
    if buy_amount < (min_stake * 1.5):
      buy_amount = min_stake * 1.5
    if buy_amount > max_stake:
      return None
    ...
    log.info(
      f"Rebuy (rebuy_entry) [{current_time}] [{trade.pair}] | Rate: {current_rate} | Stake amount: {buy_amount} | Profit (stake): {profit_stake} | Profit: {(profit_ratio * 100.0):.2f}%"
    )
    if has_order_tags:
...
def short_grind_adjust_trade_position_v3(
  strategy,
  trade: Trade,
  enter_tags,
  current_time: datetime,
  ...
  **kwargs,
  ...
  is_short_grind_entry = strategy.short_grind_entry_v3(last_candle, previous_candle, slice_profit, True)
  is_short_rebuy_entry = strategy.short_rebuy_entry_v3(last_candle, previous_candle, slice_profit, True)
